...
<%@ page import="com.ibm.smartcloud.core.util.*" %>
<!DOCTYPE HTML>
<html>
<head>
            ...
            <div class="columnauto">
              <div class="widget-box nostyle">
                <table class="table table-bordered data-table with-check table-hover no-search no-select">
                    ...
                    for(JsonNode jn : list){			
            			...
            			String subNode = node.get("2").asText();
      		...
      		%>
            		<tr>
                      ...
                      <% if("0".equals(status)){%>
            				<td style="text-align:center;"><img src="img/icons/common/icon_paused.png"><b>未执行</b></td>
            			 <%}else if("1".equals(status)){%>
            				<td style="text-align:center;"><img src="img/icons/common/icon_resized.png"><b>执行中</b></td>
            			 <%}else if("2".equals(status)){%>
            				<td style="text-align:center;"><img src="img/icons/common/icon_success.png"><b>成功</b></td>
            			 <%}else{%>
            			 	<td style="text-align:center;"><img src="img/icons/common/icon_error.png"><b>失败</b></td>
            			 <%} %>
                     <%--  <td style="text-align:center;"><img src="img/icons/common/icon_success.png"><b><%=flg %></b></td> --%>
                      <td style="text-align:center;"><a href="getLogInfoDetial?uuid=<%=uuid%>&mainaddr=<%=mainaddr%>">详细</a></td>
                    </tr>
