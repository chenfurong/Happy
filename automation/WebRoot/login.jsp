...
<style type="text/css">
#header h1{padding-left:50px; background: url("img/logo.png") no-repeat; }
...
<body>
	<div id="header">
      <h1><a class="treelogo">系统自动化部署平台</a></h1>	
	</div>
       <div id="loginbox">            
           <form id="loginform" method="post" class="form-vertical" action="loginAction" />
			  <div class="logobox">
               ...
               <div class="control-group">
                   ...
                   <div class="controls">
                       <div class="input-prepend">
                       	   <div class="similarinput"><i class="icon-user"></i><input id="userName" name="userName" type="text" placeholder="用户名" class="loginTxt nobottom"/></div>
