                ...
                <!-- <form action="#" method="get" class="form-horizontal"> -->
                 <div class="form-horizontal">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                   		<input type="text" id="db2_db2base" name="db2_db2base" value="<%=db2_db2base %>v10.1"  readonly="readonly"/>
                    </div>
                  </div>
                  <div class="control-group">
                    <label class="control-label">DB2实例目录</label>
                    <div class="controls">
                      <input type="text" id="db2_dbpath" name="db2_dbpath" value="<%=db2_dbpath %>" readonly="readonly"/>
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <input type="text" id="db2_dbdatapath" name="db2_dbdatapath" value=${db2_dbdatapath } readonly="readonly"/> 
                    </div>
                  </div>
               <!--  </form> -->
              </div>
               ...
               <!--  <form action="#" method="get" class="form-horizontal" style="display:none;"> -->
                <div class="form-horizontal" style="display:none;">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" id="db2_mon_heap" name="db2_mon_heap" value="<%=db2_mon_heap %>" readonly="readonly"/>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="mainmodule">
                ...
                <div class="form-horizontal" style="display:none;">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <div class="inputb2l">
                      <input type="text" id="db2_db2log" name="db2_db2log" value="<%=db2_db2log %>" readonly="readonly"/></div>
                      <div class="inputb2l">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" id="db2_backuppath" name="db2_backuppath" value="<%=db2_backuppath %>" readonly="readonly"/>
                    </div>
                  </div>
                  <div class="control-group">
