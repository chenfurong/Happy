...
import com.ibm.smartcloud.openstack.core.exception.OPSTStatusException;
...
public class HttpClientUtil {
	 ...
	 */
	public static String getMethod(String tokenId, String url) throws OPSTBaseException {
	 ...
	 */
	public static String postMethod(String tokenId, String url, String bodyJson) throws OPSTBaseException {
		...
		/*
		 * HttpPost postMethod = new HttpPost(url);
		 * postMethod.addRequestHeader("Content-Type", "application/json"); if
		 * (tokenId != null) { postMethod.setRequestHeader("X-Auth-Token",
		 * tokenId); } if (bodyJson != null) { logger.info("post json=" +
		 * bodyJson); try { bodyJson = StringUtil.unicodeEscape(bodyJson);
		 * logger.debug("post json=" + bodyJson);
		 * postMethod.setRequestEntity(new StringRequestEntity(bodyJson,
		 * "application/json", null)); } catch (UnsupportedEncodingException e)
		 * { e.printStackTrace(); throw new
		 * OPSSystemException("HttpClientUtil在编码时出现异常，类型为：" + e.getMessage(),
		 * e); } } return executeMethod(postMethod);
		 */
	}
	 ...
	 * @throws OPSTBaseException
	 */
	public static String postMethod(String url, String bodyJson) throws OPSTBaseException {
		 ...
		 * "application/json"); if(bodyJson!=null){
		 * logger.debug("post json="+bodyJson); try { bodyJson =
		 * StringUtil.unicodeEscape(bodyJson);
		 * logger.debug("post json="+bodyJson); postMethod.setRequestEntity(new
	...
	public static String putMethod(String tokenId, String url) throws OPSTBaseException {
		 ...
		 * putMethod.setRequestHeader("X-Auth-Token", tokenId); return
		 * executeMethod(putMethod);
		 */
	}

	public static String deleteMethod(String tokenId, String url) throws OPSTBaseException {
		 ...
		 * deleteMethod.setRequestHeader("X-Auth-Token", tokenId); return
		 * executeMethod(deleteMethod);
		 */
	}

	public static String updateMethod(String tokenId, String url, String bodyJson) throws OPSTBaseException {
		 ...
		 * logger.debug("url = " + url); logger.debug("tokenId===" + tokenId);
		 * PutMethod putMethod = new PutMethod(url);
		 * putMethod.addRequestHeader("Content-Type", "application/json"); if
		 * (tokenId != null) { putMethod.setRequestHeader("X-Auth-Token",
		 * tokenId); } if (bodyJson != null) { logger.debug("post json=" +
		 * bodyJson); try { bodyJson = StringUtil.unicodeEscape(bodyJson);
	...
	public static String patchMethod(String tokenId, String url, String bodyJson) throws OPSTBaseException {
	...
	public static String postMethod(String tokenId, String url, String bodyJson, Map<String, String> headerMap,
			File postFile) throws OPSTOperationException {
	...
	public static String executeMethod(HttpRequestBase method) throws OPSTBaseException {
		...
		if (status == 400) {
			throw new OPSTStatusException(new StringBuilder().append("restful返回的错误信息").append(resStringString)
					.toString());
		}
		if (status == 401) {
			throw new OPSTStatusException(new StringBuilder().append("restful返回的错误信息").append(resStringString)
	...
	public static Map<String, Object> executeMethodReturnWithHeader(HttpRequestBase method) throws OPSTBaseException {
	...
	public static Map<String, Object> postMethodReturnWithHeader(String url, String bodyJson) throws OPSTBaseException {
